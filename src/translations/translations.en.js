...
export const translations = {
  ...
  'cc-env-var-editor-expert.errors.invalid-name': ({ name }) =>
  ...
  'cc-env-var-editor-json.errors.invalid-name': ({ name }) =>
    sanitize`<code>${name}</code> is not a valid variable name`,
  ...
  'cc-env-var-linked-services.empty.addon': ({ appName }) =>
  ...
  'cc-logs-application-view.custom-date-range.date.range-overflow': ({ max }) => `Date must be lower than ${max}`,
  'cc-logs-application-view.custom-date-range.date.range-underflow': ({ min }) => `Date must be greater than ${min}`,
  ...
  'cc-logs-application-view.progress.loading': ({ percent }) => `Loading logs: ${formatPercent(lang, percent)}`,
  'cc-logs-application-view.progress.loading.live': `Fetching realtime...`,
  'cc-logs-application-view.progress.message': ({ count }) => `${formatNumber(lang, count)} entries loaded`,

...
export const translations = {
  ...
  'cc-logs-date-range-selector.custom-date-range.next': `Décaler à l'interval suivant`,
  'cc-logs-date-range-selector.custom-date-range.previous': `Décaler à l'interval précédent`,
